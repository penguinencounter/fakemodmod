        ...
        try {
            ...
            for (String line : message) {
                ...
                String friendlyLine = line.toLowerCase(Locale.getDefault())
                        .replaceAll("\\s", "-")
                        .replaceAll("[^a-z0-9-]", "");
                String modid = String.format("fmm-%0" + width + "d--%s", i, friendlyLine);
                String modname = String.format("fmm-%0" + width + "d | %s", i, line);
                FabricLoaderInterface.addMod(FabricLoaderImpl.INSTANCE,
                        FabricLoaderInterface.createPlain(
                                ...
                                new V1ModMetadata(
                                        ...
                                        false,
                                        modname,
                                        "Runtime-generated mod - provided by FakeModMod",
                                        List.of(),
                                        List.of(),
